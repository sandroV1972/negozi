...
-- FORNITORI
INSERT INTO negozi.fornitori (piva, nome_fornitore, indirizzo, email, telefono) VALUES
  ('01234567890', 'Vintage Computer Wholesale SRL', 'Via Industriale 45, Segrate (MI)', 'info@vintagewholesale.it', '02-87654321'),
  ('09876543210', 'Retro Gaming Italia SPA', 'Viale Europa 123, Roma', 'vendite@retrogamingitalia.it', '06-12345678'),
  ('11223344556', 'Classic Electronics Distribution', 'Corso Francia 88, Torino', 'ordini@classicelectronics.it', '011-9876543'),
  ('66554433221', 'Old School Tech Supply', 'Via Bologna 67, Firenze', 'supply@oldschooltech.it', '055-7654321')
...
INSERT INTO negozi.listino_negozio (negozio, prodotto, prezzo_listino, magazzino) VALUES
  ...
  (1,26,49.99,6),(1,27,39.99,14),(1,28,54.99,5),(1,29,59.99,4),(1,30,32.99,18),
  -- Roma (negozio 2)
  ...
  (2,26,52.99,5),(2,27,42.99,12),(2,28,57.99,4),(2,29,62.99,3),(2,30,34.99,15),
  -- Torino (negozio 3)
  ...
  (3,26,47.99,4),(3,27,37.99,10),(3,28,52.99,3),(3,29,57.99,2),(3,30,36.99,12),
  -- Bologna (negozio 4)
  ...
  (4,26,54.99,3),(4,27,44.99,8),(4,28,59.99,2),(4,29,54.99,2),(4,30,29.99,10),
  -- Firenze (negozio 5)
  ...
  (5,26,48.99,4),(5,27,38.99,11),(5,28,55.99,3),(5,29,56.99,3),(5,30,31.99,14);
